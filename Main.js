...
const Main = (props) => {
  ...
  return (
   <>
   {
    ...
    <SocialActions>
    <button> 
         <img onClick={IncNum}  src="/images/like.svg" alt="" />
         <span>like</span>
       </button>
       <button> 
         <img onClick={DecNum} src="/images/comments-icon.svg" alt="" />
         <span>Comments</span>
       </button>
       <button> 
         <a href="whatsapp://send?text=This is WhatsApp sharing example using link" 		data-action="share/whatsapp/share"
		     target="_blank"> <img  src="/images/share-icon.svg" alt="" /> </a> 
          <a href="whatsapp://send?text=This is WhatsApp sharing example using link" 		data-action="share/whatsapp/share"
	     	target="_blank"> Share </a>  
       </button>
       <button>
       <a href="whatsapp://send?text=This is WhatsApp sharing example using link" 		data-action="share/whatsapp/share"
		     target="_blank"> <img  src="/images/send-icon.svg" alt="" /> </a> 
          <a href="whatsapp://send?text=This is WhatsApp sharing example using link" 		data-action="share/whatsapp/share"
